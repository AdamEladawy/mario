...
public class CollisionChecker {
    ...
    public void checkTile(Entity entity) {
        ...
        switch (entity.direction) {
            case "up":
                entityTopRow = (entityTopWorldY - entity.getParticleSpeed()) / gp.tileSize;
                ...
                break;
            case "down":
                entityBottomRow = (entityBottomWorldY + entity.getParticleSpeed()) / gp.tileSize;
                ...
                break;
            case "left":
                entityLeftCol = (entityLeftWorldX - entity.getParticleSpeed() ) / gp.tileSize;
                tileNum1 = gp.getTileM().mapTileNum[gp.currentMap][entityLeftCol][entityTopRow];
                ...
                break;
            case "right":
                entityRightCol = (entityRightWorldX + entity.getParticleSpeed()) / gp.tileSize;
    ...
    public int checkObject(Entity entity, boolean player) {
        ...
        for (int i = 0; i < gp.obj[1].length; i++) {
            if (gp.obj[gp.currentMap][i] != null) {
                ...
                // Get the mario.game.entities.object's solid are position
                ...
                switch (entity.direction) {
                    case "up":
                        entity.solidArea.y -= entity.getParticleSpeed();
                        break;
                    case "down":
                        entity.solidArea.y += entity.getParticleSpeed();
                        break;
                    case "left":
                        entity.solidArea.x -= entity.getParticleSpeed();
                        break;
                    case "right":
                        entity.solidArea.x += entity.getParticleSpeed();
                        break;
