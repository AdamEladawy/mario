...
import mario.game.entities.object.OBJ_Fireball;
import mario.game.entities.object.OBJ_Key;
import mario.game.entities.object.OBJ_Shield_Wood;
import mario.game.entities.object.OBJ_Sword_Normal;
...
//switch (objectName){
    ...
    public void checkLevelUp() {
        ...
        if (exp >= nextLevelExp) {
            ...
            gp.playSE(8);
            gp.setGameState(gp.dialogueState);
            gp.ui.setCurrentDialogue("You are level " + level + " now! /n" + "You fell stronger");
    ...
    public void selectItem() {
        ...
        int itemIndex = gp.ui.getItemIndexOnSlot(gp.ui.getPlayerSlotCol(), gp.ui.getPlayerSlotRow());
